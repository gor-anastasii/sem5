...
void CreateService(const wstring& serviceName, const wstring& binaryPath) {
...
void StartService(const wstring& serviceName, const wstring& watchDir, const wstring& logDir) {
...
int main(int argc, char* argv[]) {
    ...
    if (operation == "Create" && argc == 4) {
        ...
        CreateService(serviceName, binaryPath);
    }
        ...
        StartService(serviceName, watchDir, logDir);
    }
